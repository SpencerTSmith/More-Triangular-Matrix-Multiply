...
extern "C" void compute_device(int m0, int n0, float *A_distributed, float *B_distributed,
                               float *C_distributed);

extern "C" void allocate_device(int m0, int n0, float **A_device, float **B_device,
                                float **C_device);
...
extern "C" void distribute_data_to_device(int m0, int n0, float *A_distributed,
                                          float *B_distributed, float *A_device, float *B_device);
...
void distribute_data_to_device(int m0, int n0, float *A_distributed, float *B_distributed,
...

{
    ...
    // Run the kernel
    cuda_trmm<<<grid_dim, block_dim>>>(m0, n0, A_distributed, B_distributed, C_distributed);
